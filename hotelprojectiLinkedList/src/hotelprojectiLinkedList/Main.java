package hotelprojectiLinkedList;
...
public class Main {
	...
	static LinkedList<Integer>arrid =new  LinkedList<Integer>();
	public static LinkedList<String> arrname=new  LinkedList<String>();
	static LinkedList<Integer>arrroom =new  LinkedList<Integer>();
	static LinkedList<Integer> arrdate=new  LinkedList<Integer>();
	...
	public static void main(String[] args) throws IOException {
		...
		case "6":
		{
			System.out.println("customerID"+"   |"+"name"+"  | "+"room number"+"  | "+"date");
			for(int g=0;g<id;g++)
			{ 
